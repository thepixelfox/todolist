<template>
  <div
    class="w-full min-h-[15rem] rounded-lg border-t-2 border-gray-custom-light p-3 gap-3 flex flex-col justify-center items-center"
  >
    <svg
      width="56"
      height="56"
